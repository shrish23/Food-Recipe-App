...
public class InstructionStepAdapter extends RecyclerView.Adapter<InstructionStepViewHolder> {
    ...
    public void onBindViewHolder(@NonNull InstructionStepViewHolder holder, int position) {
        ...
        holder.recycler_instructions_ingredients.setLayoutManager(new LinearLayoutManager(context,RecyclerView.HORIZONTAL,false));
        ...
        holder.recycler_instructions_equipments.setLayoutManager(new LinearLayoutManager(context,RecyclerView.HORIZONTAL,false));
